...
Eight screens: the goal · the pipeline · reference vs. rebuilt 3D · Blender as a
control space · camera as a human gesture · what worked and what held it back ·
current state and next iteration · credits.

By Miguel Ángel Ballesteros, Alba Díaz and Teyo Cuadrado.
Experimental material — shows current possibilities and limits of the workflow.
